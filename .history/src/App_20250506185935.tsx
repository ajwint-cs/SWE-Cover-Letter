        ...
        <div className="backdrop-blur-xl bg-gray-900/80 rounded-xl p-8 shadow-[0_8px_32px_0_rgba(31,38,135,0.37)] border border-gray-800 hover:bg-gray-800/80 transition-all duration-300">
          ...
          <div className="space-y-4">
            ...
            <p>
              ...
              Windows Active Directory, Sharepoint, print/file servers, and
              more. In a cybersecurity scope, I've deployed SIEM systems,
              configured security monitoring, and managed secure network
              architectures. I'm passionate about protecting vulnerable systems
              and individuals from digital threats, which drives my continuous
              learning in security operations, incident response, and threat
              analysis. My background in Civil Air Patrol, where I achieved the
              rank of cadet captain, reinforces my commitment to security
              protocols and disciplined approach to cybersecurity challenges.{" "}
            </p>
          </div>
        </div>
